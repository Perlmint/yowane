...
/***/ function(module, exports, __webpack_require__) {
	...
	// Space filling
	$(document).ready(() => {
	    const paperManager = new canvas_manager_1.CanvasManager("paper", 500, 500, 100);
	    const oritatamiCanvas = new canvas_manager_1.CanvasManager("oritatami", 500, 500, 100);
	    const oritatami = this._oritatami = new renderer_oritatami_1.OritatamiRenderer(oritatamiCanvas);
	    const renderer = new renderer_spacefill_1.SpaceFillRenderer(paperManager, oritatami, new renderer_1.Theme({
	        a: "#000",
	        z: "#F00"
	    }));
	    renderer.drawGrid();
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	/// <reference path="../typings/index.d.ts" />
	const oritatami_1 = __webpack_require__(6);
	const grid_1 = __webpack_require__(3);
	__webpack_require__(4);
	const $ = __webpack_require__(7);
	const renderer_1 = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	/// <reference path="../typings/index.d.ts" />
	const spacefilling_1 = __webpack_require__(9);
	const spacefill_input_manager_1 = __webpack_require__(10);
	const grid_1 = __webpack_require__(3);
	__webpack_require__(4);
	const $ = __webpack_require__(7);
	const renderer_1 = __webpack_require__(2);

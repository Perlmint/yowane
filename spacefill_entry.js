...
/***/ function(module, exports, __webpack_require__) {
	...
	const canvas_manager_1 = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	class SpaceFillRenderer extends renderer_1.Renderer {
	    ...
	    onInputEnded() {
	        ...
	        let idx = 0;
	        let itr = oritatami.push(grid, new grid_1.Point(0, 0), seqs[0]); // first block
	        let lp = new grid_1.Point(0, 0);
	        function run(iterator, seq) {
	            let innerIdx = 0;
	            let lastPoint = lp;
	            do {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const Raphael = __webpack_require__(11);
	const grid_1 = __webpack_require__(3);
	const ZOOM_MAX = 5;
	const ZOOM_MIN = 0.2;

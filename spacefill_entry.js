...
/***/ function(module, exports, __webpack_require__) {
	...
	$(document).ready(() => {
	    ...
	    let renderer = new renderer_spacefill_1.SpaceFillRenderer(paperManager, "oritatami", new renderer_1.Theme({
	        a: "#000",
	        z: "#F00"
	    }));
	    renderer.drawGrid();
...
/***/ function(module, exports, __webpack_require__) {
	...
	const $ = __webpack_require__(11);
	const renderer_1 = __webpack_require__(2);
	const renderer_oritatami_1 = __webpack_require__(12);
	const NODE_ANIMATION_MS = 500;
	const PATH_ANIMATION_MS = 300;
	class SpaceFillRenderer extends renderer_1.Renderer {
	    ...
	    onInputEnded() {
	        ...
	        const oritatami = this._oritatami = new renderer_oritatami_1.OritatamiRenderer(canvas);
	        oritatami.drawGrid();
